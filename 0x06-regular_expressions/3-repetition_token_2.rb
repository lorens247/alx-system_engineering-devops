...
# `/hbt+n/` is a regular expression that matches the string "hbtn" or "hbttn" or "hbtttn" or "hbttttn", etc.
# `+` is a quantifier that matches the previous token "t" one or more times
